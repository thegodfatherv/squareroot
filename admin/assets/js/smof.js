...
jQuery(document).ready(function ($) {
	...
	//		$('#of_container #content').removeAttr("style");
	//		/*end Squareroottheme*/
	...
	/**    Ajax Generate Less Css */
	$('#of_generate_less').live('click', function () {

		var answer = confirm("Click OK to Generate.")
		var nonce = $('#security').val();
		...
		if (answer) {
			...
			$.post(ajaxurl, data, function (response) {
				var fail_popup = $('#of-popup-fail');
				var success_popup = $('#of-generate-less-popup');
